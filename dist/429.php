...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>429 Too Many Requests - Wayne State University</title>
                            ...
                            <div class="xlarge-12 columns">
                                <div class="row collapse">
                                    <div class="medium-10 small-10 columns">
                                        <label for="q-search">Search wayne.edu:</label>
                                        <input type="text" name="q" class="q" id="q-search" placeholder="Search">
                                    </div>
