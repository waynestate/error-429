...
gulp.task('symlink', function(){
    ...
    gulp.src(targetAppDir + '/429.css')
        .pipe(sym(targetAppDir + '/_resources/css/429.css', { force: true}));
    gulp.src(targetAppDir + '/429.css.map')
        .pipe(sym(targetAppDir + '/_resources/css/429.css.map', { force: true}));
    gulp.src(targetAppDir + '/429.png')
        .pipe(sym(targetAppDir + '/_resources/images/429.png', { force: true}));
});
